package edu.northeastern.ccs.stemmer;
...
public class DiceCoefficient {
	...
	private static DiceCoefficient instance = null;
	
	public static DiceCoefficient getInstance() {
		if(instance == null) {
			instance = new DiceCoefficient();
		}
		return instance;
	}
	...
	public static double diceCoefficientOptimized(String s, String t)
	{
		...
		int[] sPairs = bigramsForS(s,t);
		int[] tPairs = bigramsForT(s,t);
	...
	public static int[] bigramsForS(String s, String t) {
	...
	public static int[] bigramsForT(String s, String t) {
		final int m = t.length()-1;
